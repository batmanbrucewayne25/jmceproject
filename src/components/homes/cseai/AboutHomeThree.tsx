                    ...
                    <div className="row g-4 justify-content-between">
                        <div className="col-xl-6 col-lg-6">
                            <div className="about-content">
                                ...
                                The B.E. in Artificial Intelligence and Machine Learning program trains students to build intelligent, autonomous, and data-driven systems. 
                                The curriculum covers machine learning, deep learning, neural networks, NLP, computer vision, robotics, and reinforcement learning with hands-on experience using modern AI frameworks.
                                </p>
                                <p className="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                Students are encouraged to participate in innovation labs, R&D projects, Kaggle competitions, and AI startup incubation activities. The program includes structured placement-oriented training that prepares students 
                                for roles in AI engineering, data analytics, automation, and research
                                </p>
