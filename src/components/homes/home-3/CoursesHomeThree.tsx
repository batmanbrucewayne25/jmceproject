                        ...
                        <div className="row">
                            <div className="col-xl-3 col-lg-3 col-md-6">
                                <div className="popular-courses-items">
                                    <div className="popular-thumb">
                                        ...
                                        <div className="thumb">
                                            <img src="assets/img/own/cse.svg" alt="img" />
                                        </div>
                                    </div>
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-6">
                                <div className="popular-courses-items bg-2">
                                    <div className="popular-thumb">
                                        <div className="post-box">
                                            <Link to="/cseai" className="post-cat">
                                                CSE
                                            </Link>
                                        </div>
                                        <div className="thumb">
                                            <img src="assets/img/own/cseai.svg" alt="img" />
                                        </div>
                                    </div>
                                    <div className="content">
                                        <h4>
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-6">
                                <div className="popular-courses-items bg-3">
                                    <div className="popular-thumb">
                                        ...
                                        <div className="thumb">
                                            <img src="assets/img/own/cseml.svg" alt="img" />
                                        </div>
                                    </div>
                                    <div className="content">
                                        <h4>
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-6">
                                <div className="popular-courses-items bg-2">
                                    <div className="popular-thumb">
                                        ...
                                        <div className="thumb">
                                            <img src="assets/img/own/me.svg" alt="img" />
                                        </div>
                                    </div>
                                    <div className="content">
                                        <h4>
