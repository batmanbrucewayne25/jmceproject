...
const ChooseHomeThree = () => {
  ...
  return (
    <>
       <section className="choose-us-section-3 fix section-padding pt-5">
           <div className="choose-us-wrapper-3">
                <div className="row g-0">
                    <div className="col-xxl-7 col-xl-6 col-lg-6">
                        <div className="video-image wow img-custom-anim-left">
                            <img src="assets/img/own/youtube.svg" alt="img" />
                            <a 
                    ...
                    <div className="col-xxl-5 col-xl-6 col-lg-6">
                        <div className="choose-content">
                            ...
                            JMCE provides students centric support for their Innovative technical dreams in to real through Centre of Excellence
                            </p>
                            {/* <div className="row">
