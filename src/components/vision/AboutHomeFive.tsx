...
//   const percentage2 = 76
  ...
  return (
    <>
      <section className="about-section fix section-padding pt-5">
                        ...
                        <div className="col-lg-6">
                            {/* <div className="about-image"> */}
                                ...
                                <div className="about-image-2">
                                    <img src="assets/img/own/vision.png" alt="img" className="wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.5s" />
                                </div>
                            {/* </div> */}
                        </div>
                        <div className="col-lg-6">
                            <div className="about-content">
                                ...
                                To emerge as a leading center of excellence in engineering and management education by fostering innovation, 
                                industry relevance, and ethical values, while empowering students with knowledge, skills, and social responsibility to contribute meaningfully to national and global development.
                                </p>
