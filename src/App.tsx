...
import Publications from "./components/publishing";
import Iqac from "./components/iqac";
import Iic from "./components/naac";
...
const router = createBrowserRouter([
  ...
  { path: "/icte", element: <Icte /> }, 
  { path: "/alumini", element: <Alumini /> }, 
  { path: "/coe", element: <Coe /> }, 
